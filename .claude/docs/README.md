...
| [前端开发指南](./前端开发指南.md) | 技术栈、组件规范、API 对接（dataObj 结构） | 前端/前后端联调 |
| [Mixin使用指南](./Mixin使用指南.md) | getOrgList、getMealTimeList、settingClomnsMixin 等 5 个 Mixin | 前端开发 |
| [路由配置指南](./路由配置指南.md) | 路由文件结构、懒加载规范、meta 配置、权限流程 | 前端路由配置 |
...
| 遇到的问题 | 查阅文档 |
|-----------|---------|
| 不知道后端代码怎么写 | [后端开发指南](./后端开发指南.md) |
| 不知道表怎么设计 | [数据库设计规范](./数据库设计规范.md) |
| 不知道工具类怎么用 | [工具类使用指南](./工具类使用指南.md) |
| 需要实现审批流程 | [工作流开发指南](./工作流开发指南.md) |
| 需要给前端提供 API / 写前端接口 | [前端开发指南](./前端开发指南.md) |
| 前端 Mixin 怎么用 | [Mixin使用指南](./Mixin使用指南.md) |
| 前端路由怎么配置 | [路由配置指南](./路由配置指南.md) |
